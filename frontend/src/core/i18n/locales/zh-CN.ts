...
export const zhCN: Translations = {
  ...
  agents: {
    ...
    visibilityOrgShared: "组织共享",
    myAgentsTitle: "我的智能体",
    myAgentsDescription: "仅你可见，或由你创建并管理的智能体。",
    myAgentsEmpty: "你还没有创建任何智能体。",
    sharedAgentsTitle: "组织共享智能体",
    sharedAgentsDescription: "组织内共享，可直接使用但不一定可编辑。",
    sharedAgentsEmpty: "当前还没有可用的组织共享智能体。",
