...
export interface Translations {
  ...
  agents: {
    ...
    visibilityOrgShared: string;
    myAgentsTitle: string;
    myAgentsDescription: string;
    myAgentsEmpty: string;
    sharedAgentsTitle: string;
    sharedAgentsDescription: string;
    sharedAgentsEmpty: string;
