...
export interface Translations {
  ...
  skills: {
    ...
    uploadRequirementExtension: string;
    uploadRequirementStructure: string;
    uploadRequirementFrontmatter: string;
    uploadRequirementName: string;
    uploadRequirementOptionalFiles: string;
    detailTitle: string;
    ...
    filePathHint: string;
    savingFile: string;
    fileSaveSuccess: string;
    fileSaveFailed: string;
    fileCreateSuccess: string;
    fileCreateFailed: string;
    fileRenameSuccess: string;
